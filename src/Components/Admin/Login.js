...
import { useState } from 'react';//864
...
function Login() {
    ...
    async function handleLogin() {
        try {
            ...
            const response = await login({email:"zezo@gmail.com", password:"2222"})
        ...
        //     alert("Login Successful, press OK button and please wait.")
    ...
    return (
        <div className='grid place-items-center h-screen'>
            <div className='h-[50%] bg-gray-900 w-[35%] rounded-3xl'>
                <div className='w-[26%] mx-auto -mt-[13%]'><img src='/img/sss.png' className='rounded-full' alt='logo' /></div>
                ...
                <div className='my-8'>
                    ...
                    <div className='justify-center mt-[8%] flex'><svg className="w-10 mr-2 fill-gray-600" viewBox="0 0 512 512">
                        ...
                        <input className='focus:outline-none bg-gray-600 rounded-full p-[2.5%] w-[70%] text-white placeholder:text-left' placeholder='Email' name='email' type="email" value={email} onChange={(e) => setEmail(e.target.value)} required /></div>
                    ...
                    <div className='justify-center mt-[5%] flex'><svg className="w-10 mr-2 rounded-l-full fill-gray-600" viewBox="0 0 512 512">
                        ...
                        <input className='focus:outline-none bg-gray-600 rounded-l-full p-[2.5%] w-[63%] text-white placeholder:text-left' placeholder='Password' name='password' value={password} onChange={(e) => setPassword(e.target.value)} type={passwordShown ? 'text' : 'password'} required />
                    ...
                    <div className='w-fit mx-auto my-[5%]'>
                        <button type='submit' value="Login" className='p-[12%] bg-blue-800 w-28 rounded-full text-white hover:bg-blue-600 font-semibold' onClick={handleLogin}>Login</button>
                    </div>
                </div>
            </div>
        </div>
